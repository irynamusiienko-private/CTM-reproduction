#!/bin/bash
#SBATCH --job-name=eval_cutmix1
#SBATCH --output=eval_cutmix1_%j.out
#SBATCH --error=eval_cutmix1_%j.err
...
PRED_DIR="/home/woody/mrrr/mrrr108v/tda-reproduction/outputs/infercutmix1_tta"
