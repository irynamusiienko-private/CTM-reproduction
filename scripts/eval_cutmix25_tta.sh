#!/bin/bash
#SBATCH --job-name=eval_cutmix25
#SBATCH --output=eval_cutmix25_%j.out
#SBATCH --error=eval_cutmix25_%j.err
...
PRED_DIR="/home/woody/mrrr/mrrr108v/tda-reproduction/outputs/infercutmix25_tta"
