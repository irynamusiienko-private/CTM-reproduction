#!/bin/bash
#SBATCH --job-name=train_cutmix10
#SBATCH --output=/home/woody/mrrr/mrrr108v/tda-reproduction/logs/train_cutmix10_%j.out
#SBATCH --error=/home/woody/mrrr/mrrr108v/tda-reproduction/logs/train_cutmix10_%j.err
...
python /home/woody/mrrr/mrrr108v/tda-reproduction/scripts/train.py \
  ...
  --results_dir /home/woody/mrrr/mrrr108v/tda-reproduction/outputs/cutmix10 || { echo "Training script failed"; exit 1; }
